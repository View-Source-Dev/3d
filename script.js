...
const stackClockTimes = Array.from(document.querySelectorAll(".stack-clock-time"));
...
function updateClocks() {
  if (!stackClockTimes.length || isMobileViewport()) {
    return;
  }

  const now = new Date();
  stackClockTimes.forEach((node) => {
